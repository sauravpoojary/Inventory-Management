...
public enum ErrorCode {
	...
	INSTOCK_CANNOT_BE_NEGATIVE(BAD_REQUEST, "Instock is less than zero!!"),
	RESERVE_CANNOT_BE_NEGATIVE(BAD_REQUEST, "Reserve is less than zero!!"),
	DEMAND_CANNOT_BE_NEGATIVE(BAD_REQUEST, "Demand is less than zero!!"),
	ACTION_NOT_EQUAL_TO_REPLACE_OR_ADD(BAD_REQUEST, "Add a proper action!!"),
    CANNOT_BE_NULL(INTERNAL_SERVER_ERROR, "System error"),
    CANNOT_BE_EMPTY(INTERNAL_SERVER_ERROR, "System error"),
    PRODUCTSKU_MUST_BE_UNIQUE(BAD_REQUEST, "Duplicate Entry!!!"),
